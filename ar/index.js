...
(function() {
  var load = (function() {
    ...
    var images = ["./640.jpg", "/DiaoChan_D_512.png", "/DiaoChan_Taikongcang_D_512.png", "/DiaoChan_Taikongcang_D_512.png", "/target.png", "/music_icon.png"];
    ...
    function ing() {
      for (var i = 0; i < images.length; i++) {
        var img = new Image();
        var url = images[i];
        img.src = url.startsWith('./640.jpg') ? url : path + url;
        img.onload = function() {
          loaded++;
          num(loaded / (images.length + 3) * 100)
        }
  ...
  function init() {
    ...
    loader.load("//ossweb-img.qq.com/images/yxzj/act/a20161130ar/dc_mini.js", function(geometry, materials) {
      ...
      loader.load("//ossweb-img.qq.com/images/yxzj/act/a20161130ar/pd.js", function(geometry, materials) {
        var config = {
          name: "piaodai",
          g: geometry,
          m: materials
    ...
    loader.load("//ossweb-img.qq.com/images/yxzj/act/a20161130ar/jc_s.js", function(geometry, materials) {
      var config = {
        name: "jichan",
        g: geometry,
        m: materials
  ...
  function resetLocationAndRotation() {
    ...
    if (need_3droom) {
      ...
      var material = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./640.jpg")
      });
    ...
    var dc_ro_tween = new TWEEN.Tween(diaochan.rotation).to({
      x: 1,
      y: -1.8,
      z: 1.57
    },
  ...
  function animate() {
    ...
    if (meshPool["diaochan"].status == 4) {
      ...
      meshPool["diaochan"].action.setEffectiveTimeScale(0.5);
      var rot = new TWEEN.Tween(meshPool["diaochan"].rotation).to({
        x: 0.5,
        y: -1.8,
        z: 1.57
      }, 500).start();
